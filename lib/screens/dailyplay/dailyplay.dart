...
import 'package:npadmin/screens/dailyplay/questions.dart';

import '../../constants.dart';

class DailyPlayScreen  extends StatefulWidget {
  DailyPlayScreen ({Key? key}) : super(key: key);

  @override
  State<DailyPlayScreen > createState() => _DailyPlayScreenState();
}

class _DailyPlayScreenState extends State<DailyPlayScreen > {
  void initState(){
    quest(index);
    super.initState();
  }
                ...
                if(questionController.text.toString().isNotEmpty&&c>=0&&_controllers.length>1&&c<_controllers.length)
                  {
                    ...
                    DocumentReference question = FirebaseFirestore.instance.collection('question').doc('$index');
                    question.set(
                        {
                          "id": index,
